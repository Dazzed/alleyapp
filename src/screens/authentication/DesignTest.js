...
export default class DesignTest extends Component {
  constructor() {
    super();
    this.state = {
      email: '',
            ...
            <KeyboardAwareScrollView style={{backgroundColor: 'white'}}>
              <ScrollView keyboardShouldPersistTaps='handled'>
                <View style={style.subContainer}>
                  ...
                  <TouchableHighlight style={style.touchableStyleLogin} onPress={() => this.props.navigation.navigate('forgotPassword')}>
                    <Text style={style.loginText}>Log in</Text>
                  </TouchableHighlight>
                  <Text style={style.signupText}>Don't have an account? <Text style={style.signup} onPress={() => alert('Clikc Signup')}>Sign up</Text></Text>
                </View>
