...
import { DAUGHTER_CREATE_MUTATION } from '../../graphql/mutation';
...
export default class DaughterProfile extends Component {
  ...
  createDaughter = async targetMutation => {
    try {
      const {
        daughter_name,
        dob,
      ...
      if (email != "") {
        const data = await targetMutation({ variables: { phone, name, dateOfBirth, address, interests, affiliations, email } });
      } else {
        const data = await targetMutation({ variables: { phone, name, dateOfBirth, address, interests, affiliations } });
      }
      console.log(data);
          ...
          <View style={style.container}>
            <View style={style.subContainer}>
              ...
              <Button raised
                ...
                style={style.button}
                onPress={this.createDaughter.bind(this, user_C)}
              />
            </View>
          </View>
        )}
