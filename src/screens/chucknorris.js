...
import { View, ScrollView, Text, ActivityIndicator, Image, StatusBar } from 'react-native';
    ...
    return (
      <View style={{ alignItems: 'center' }}>
        <Image
          ...
          resizeMethod={'auto'}
          source={{
            uri: 'https://assets.chucknorris.host/img/chucknorris_logo_coloured_small.png'
          }}
        />
      </View>
    );
